<script setup>
  ...
  import { calculaCantidadPagar } from './helpers'
  ...
  watch([cantidad, meses], () => {
    total.value = calculaCantidadPagar(cantidad.value, meses.value);
  });
...
<template>
    ...
    <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <p v-else class="text-center"> Añade una cantidad a pagar </p>
